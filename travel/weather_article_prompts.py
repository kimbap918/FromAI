...
# 출력 형식
- 제목은 다음 3가지 형식으로, 순서대로 각 한 줄씩 작성한다:
  - [지역명] 날씨, [핵심 날씨 특징]
  - [지역명] 날씨, [다른 관점의 날씨 특징]
  - [지역명] 날씨, [시간대별 또는 전망 위주]
- 제목 다음에는 기사 본문을 서술형 문단으로 작성한다.
- 마지막으로 #해시태그 를 한 줄 이상 작성한다.
...
# 출력 형식
- 제목은 다음 3가지 형식으로, [기상특보]로 시작하여 순서대로 각 한 줄씩 작성한다:
  - [기상특보] [지역명] [특보종류], [핵심 특보 특징]
  - [기상특보] [지역명] [특보종류], [다른 관점의 특보 특징]
  - [기상특보] [지역명] [특보종류], [현재 기상상황 또는 영향]
- 제목 다음에는 기사 본문을 서술형 문단으로 작성한다.
- 마지막으로 #해시태그 를 한 줄 이상 작성한다.
