...
BASE_SYSTEM_PROMPT = (
    ...
    아래 [News Generation Process (Step-by-Step Execution)]와 [Special Rules for Stock-Related News]를 단계별로 실행하고, 최종적으로 **[Output Format]에 맞게 기사를 출력합니다.**
    ...
    **- 최종 출력은 [제목], [해시태그], [본문]의 세 섹션으로 명확히 구분하여 작성할 것.** 
