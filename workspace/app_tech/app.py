...
# 카카오톡 "나에게 보내기"용 Access Token (카카오에서 미리 발급해둔 것)
...
def send_kakao_to_me(access_token: str, text: str):
    ...
    access_token : 카카오 OAuth로 발급받은 사용자 액세스 토큰
    """
    if not access_token:
